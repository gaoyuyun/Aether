...
INSERT INTO usage_settlement_snapshots (
    ...
    'mysql-backfill-completed', 'settled', 2.5, 100, 30, 10, 20,
    JSON_OBJECT(
        'provider_quota_cost_usd', 2.5,
        'pricing_snapshot', JSON_OBJECT('provider_billing_type', 'monthly_quota')
    )
);
"#,
    )
...
INSERT INTO usage_settlement_snapshots (
    ...
    'sqlite-backfill-completed', 'settled', 2.5, 100, 30, 10, 20,
    '{"provider_quota_cost_usd":2.5,"pricing_snapshot":{"provider_billing_type":"monthly_quota"}}',
    1, 1
)
"#,
    )
...
async fn run_backfills_rebuilds_stats_and_records_execution() {
    ...
    assert_eq!(pending_before[7].version, 20260817010000);
