...
pub(super) async fn mysql_delete_table(
...
pub(super) async fn mysql_delete_non_admin_user_rows(
    tx: &mut sqlx::Transaction<'_, sqlx::MySql>,
    table: &str,
    summary: &mut AdminSystemPurgeSummary,
) -> Result<(), DataLayerError> {
...
pub(super) async fn mysql_delete_non_admin_api_key_rows(
    tx: &mut sqlx::Transaction<'_, sqlx::MySql>,
    table: &str,
    summary: &mut AdminSystemPurgeSummary,
) -> Result<(), DataLayerError> {
...
pub(super) async fn mysql_execute_if_table(
    tx: &mut sqlx::Transaction<'_, sqlx::MySql>,
    table: &str,
    key: &str,
    sql: &str,
...
pub(super) async fn mysql_execute_if_table_has_columns(
    tx: &mut sqlx::Transaction<'_, sqlx::MySql>,
    table: &str,
    columns: &[&str],
    key: &str,
...
pub(super) async fn mysql_execute_batch_if_table(
    tx: &mut sqlx::Transaction<'_, sqlx::MySql>,
    table: &str,
    key: &str,
    sql: &str,
...
pub(super) async fn mysql_execute_batch_if_table_has_columns(
    tx: &mut sqlx::Transaction<'_, sqlx::MySql>,
    table: &str,
    columns: &[&str],
    key: &str,
...
pub(super) async fn mysql_table_exists(
    tx: &mut sqlx::Transaction<'_, sqlx::MySql>,
    table: &str,
) -> Result<bool, DataLayerError> {
    let table = checked_sql_identifier(table)?;
...
pub(super) async fn mysql_table_has_columns(
    tx: &mut sqlx::Transaction<'_, sqlx::MySql>,
    table: &str,
    columns: &[&str],
) -> Result<bool, DataLayerError> {
