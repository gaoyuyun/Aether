...
CREATE TABLE IF NOT EXISTS public.providers (
    ...
    quota_subscription_started_at bigint,
    quota_cycle_start_at bigint,
    pending_quota_reset_mode character varying(20),
    pending_quota_reset_days integer,
    pending_quota_reset_usage boolean,
    pending_quota_reset_at timestamp with time zone,
...
CREATE TABLE IF NOT EXISTS public.usage_counter_deltas (
    ...
    quota_delta_sequence bigint GENERATED BY DEFAULT AS IDENTITY,
