...
mod tests {
    ...
    fn admin_provider_model_sql_projections_include_supported_capabilities() {
        ...
        assert_admin_provider_model_projection_has_required_columns(include_str!(
            "global_models.rs"
        ));
    ...
    fn admin_global_model_sql_projects_usage_count_from_billing_facts() {
        let source = include_str!("global_models.rs");
    ...
    fn global_model_usage_count_read_model_has_backfill_and_delta_maintenance() {
        let backfill_sql = include_str!(
            "../../../runtime/backfills/postgres/20260505120000_rebuild_global_model_usage_count.sql"
        );
        let delta_sql = include_str!("usage/queries/apply_global_model_usage_delta_sql.sql");
