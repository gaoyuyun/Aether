...
const legacyExactEnglishMessages: Record<string, string> = {
  ...
  '传输指纹': 'Transport fingerprint',
  'Key 可单独覆盖此设置。': 'Keys can override this setting.',
  '探测使用已保存的配置。': 'Probes use the saved settings.',
  '继承供应商': 'Inherit from provider',
  '已探测': 'Probed',
  '尚未探测': 'Not probed yet',
  '探测指纹': 'Probe fingerprint',
  '探测中...': 'Probing...',
  '复制完整指纹': 'Copy full fingerprint',
  '复制结果': 'Copy result',
  '推理回放缓存': 'Reasoning replay cache',
  '持续提示推理签名无效时，可清除缓存。': 'Clear the cache if reasoning signature errors persist.',
  '清除缓存': 'Clear cache',
  '清除中...': 'Clearing...',
